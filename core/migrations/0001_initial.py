    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calendar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='availabilities', to='core.calendar')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_time', models.DateTimeField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('calendar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='core.calendar')),
            ],
        ),
        migrations.CreateModel(
            name='CalendarShare',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission', models.CharField(choices=[('view_only', 'View Only'), ('edit', 'Edit'), ('admin', 'Admin')], default='view_only', max_length=20)),
